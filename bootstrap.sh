...
echo "--------------------------------------------------------"
echo "Next Steps:"
echo "1. Pre-create work directories with correct ownership:"
echo "   sudo mkdir -p $WORK_DIR && sudo chown -R 1000:1000 $WORK_DIR"
echo ""
echo "2. Run Flex Drive setup (requires sudo):"
echo "   sudo ./setup_flex_zram.sh $WORK_DIR $FLEX_DIR/zram_back $RAM_LIMIT $TOTAL_SIZE"
echo ""
echo "3. Start your runners:"
